  ...
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 32 64" className="w-full h-full">
        <defs>
          <linearGradient id="toy-body" x1="50%" y1="0%" x2="50%" y2="100%">
            <stop offset="0%" stopColor="#3d2d3d"/>
            <stop offset="100%" stopColor="#4a3848"/>
          </linearGradient>
        </defs>
        {/* Main shaft */}
        <path d="M12 4 C12 2 20 2 20 4 L20 42 L12 42 Z" fill="url(#toy-body)"/>
        <rect x="12" y="4" width="8" height="38" rx="4" fill="url(#toy-body)"/>
        {/* Rounded top */}
        <ellipse cx="16" cy="6" rx="5" ry="5" fill="#3d2d3d"/>
        {/* Side attachment */}
        <path d="M12 16 C6 16 3 22 4 28 C5 34 8 36 12 34" fill="url(#toy-body)" stroke="none"/>
        <ellipse cx="5" cy="32" rx="4" ry="5" fill="#3d2d3d"/>
        {/* Ridges on connection */}
        <path d="M11 20 C9 20.5 9 21.5 11 22" stroke="#5a4a5a" strokeWidth="0.8" fill="none"/>
        <path d="M11 23 C9 23.5 9 24.5 11 25" stroke="#5a4a5a" strokeWidth="0.8" fill="none"/>
        <path d="M11 26 C9 26.5 9 27.5 11 28" stroke="#5a4a5a" strokeWidth="0.8" fill="none"/>
        <path d="M11 29 C9 29.5 9 30.5 11 31" stroke="#5a4a5a" strokeWidth="0.8" fill="none"/>
        {/* Face base */}
        <rect x="10" y="42" width="12" height="16" rx="6" fill="#fdd5c8"/>
        {/* Eyes */}
        <circle cx="14" cy="50" r="1.5" fill="#2d1f2d"/>
        <circle cx="18.5" cy="50" r="1.5" fill="#2d1f2d"/>
        {/* Smile */}
        <path d="M14 53 Q16 55.5 18.5 53" stroke="#2d1f2d" strokeWidth="0.8" fill="none" strokeLinecap="round"/>
        {/* Cheeks */}
        <circle cx="12.5" cy="52" r="1.5" fill="#f5a0a0" opacity="0.45"/>
        <circle cx="20" cy="52" r="1.5" fill="#f5a0a0" opacity="0.45"/>
      </svg>
    ),
  ...
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 56 40" className="w-full h-full">
        {/* Left breast */}
        <path d="M4 12 C4 4 14 0 20 2 C26 4 28 10 28 16 C28 24 22 32 16 34 C10 36 4 28 4 20 Z" 
              fill="#fdd5c8" stroke="#2d1f2d" strokeWidth="2.2"/>
        {/* Right breast */}
        <path d="M52 12 C52 4 42 0 36 2 C30 4 28 10 28 16 C28 24 34 32 40 34 C46 36 52 28 52 20 Z" 
              fill="#fdd5c8" stroke="#2d1f2d" strokeWidth="2.2"/>
        {/* Cleavage line */}
        <path d="M28 6 C28 10 28 14 28 16" stroke="#2d1f2d" strokeWidth="1.5" fill="none" strokeLinecap="round"/>
        {/* Left nipple area */}
        <circle cx="16" cy="18" r="4.5" fill="#f0a0a0"/>
        {/* Left face */}
        <circle cx="14.5" cy="17" r="1" fill="#2d1f2d"/>
        <circle cx="17.5" cy="17" r="1" fill="#2d1f2d"/>
        <path d="M14 20 Q16 22 18 20" stroke="#2d1f2d" strokeWidth="0.8" fill="none" strokeLinecap="round"/>
        {/* Right nipple area */}
        <circle cx="40" cy="18" r="4.5" fill="#f0a0a0"/>
        {/* Right face */}
        <circle cx="38.5" cy="17" r="1" fill="#2d1f2d"/>
        <circle cx="41.5" cy="17" r="1" fill="#2d1f2d"/>
        <path d="M38 20 Q40 22 42 20" stroke="#2d1f2d" strokeWidth="0.8" fill="none" strokeLinecap="round"/>
      </svg>
    ),
